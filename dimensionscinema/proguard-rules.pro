...
#}
#-----------处理第三方依赖库---------#
AndroidEventBus-keep class org.simple.** { *; }
...
-keep class pvi.com.** {*;}
-dontwarn com.baidu.**-dontwarn vi.com.**-dontwarn pvi.com.**
# Bugly
...
# 高德相关依赖# 集合包:3D地图3.3.2 导航1.8.0 定位2.5.0
...
-dontwarn javax.**-dontwarn io.realm.**
# Retrofit
-dontwarn retrofit2.**
...
# xUtils3.0
-keepattributes Signature,Annotation-keep public class org.xutils.** {public protected *;}
...
-keepclassmembers class * {@org.xutils.view.annotation.Event ;}
# 银联
